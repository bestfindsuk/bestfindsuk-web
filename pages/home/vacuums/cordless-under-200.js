...
export async function getStaticProps() {
  ...
  const filtered = vacuums.filter(
    (v) => v.category === "vacuum" && v.cordless === "yes" && v.price_gbp > 120 && v.price_gbp <= 200
  );
...
export default function CordlessUnder200({ products, lastUpdated }) {
  return (
    <main style={{ maxWidth: "800px", margin: "0 auto", padding: "2rem" }}>
      ...
      <p>
        This page
        excludes products priced at £120 or less. See cordless vacuum cleaners under £120{" "}
        <Link href="/home/vacuums/cordless-under-120">here</Link>.
      </p>
      ...
      <ul>
        ...
        <li>Cordless</li>
        <li>Priced above £120 and up to £200 at the time of checking</li>
